    ...
    return (
        ...
        >
            ...
            {showCaptions && (<figcaption
                className="pointer-events-none absolute inset-x-3 bottom-3 flex items-center justify-between px-3 py-1 text-[10px] tracking-[0.4em] text-white/60">
